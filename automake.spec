...
%description -l ru
Automake - ÜÔÏ ÜËÓÐÅÒÉÍÅÎÔÁÌØÎÙÊ ÇÅÎÅÒÁÔÏÒ Makefile'Ï×. éÄÅÑ ÂÙÌÁ ÎÁ×ÅÑÎÁ
ÐÒÏÇÒÁÍÍÏÊ make É ÈÅÄÅÒÁÍÉ ÉÚ 4.4BSD, ÎÏ automake ÐÒÅÔÅÎÄÕÅÔ ÎÁ ÔÏ, ÞÔÏÂÙ
ÂÙÔØ ÐÏÒÔÁÂÅÌØÎÏÊ É ÓÏÏÔ×ÅÔÓÔ×Ï×ÁÔØ ÓÔÁÎÄÁÒÔÁÍ GNU ÎÁ ÐÅÒÅÍÅÎÎÙÅ É ÃÅÌÉ
Makefile'Ï×.
...
%description -l uk
Automake - ÃÅ ÅËÓÐÅÒÉÍÅÎÔÁÌØÎÉÊ ÇÅÎÅÒÁÔÏÒ Makefile'¦×. ¶ÄÅÑ ÂÕÌÁ ÎÁ×¦ÑÎÁ
ÐÒÏÇÒÁÍÏÀ make ÔÁ ÈÅÄÅÒÁÍÉ Ú 4.4BSD, ÁÌÅ automake ÍÁ¤ ÚÁ Ã¦ÌØ ÍÏÂ¦ÌØÎ¦ÓÔØ
ÔÁ ×¦ÄÐÏ×¦ÄÎ¦ÓÔØ ÓÔÁÎÄÁÒÔÁÍ GNU ÎÁ ÚÍ¦ÎÎ¦ Ô¦ Ã¦Ì¦ Makefile'¦×.
